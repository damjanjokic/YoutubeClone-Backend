    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Subscriptions", x => new { x.ObserverId, x.TargetId });
                    table.ForeignKey(
                        name: "FK_Subscriptions_AspNetUsers_ObserverId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dislikes", x => new { x.LikerId, x.PostId });
                    table.ForeignKey(
                        name: "FK_Dislikes_AspNetUsers_LikerId",
                        column: x => x.LikerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
